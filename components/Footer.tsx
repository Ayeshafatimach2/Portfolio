    ...
    <footer className="mx-auto max-w-3xl px-4 sm:px-6 md:max-w-5xl ">
      ...
      <div className="mx-auto  p-4 flex flex-col text-center text-neutral-900 md:flex-row md:justify-between">
        <div className="flex flex-row items-center justify-center space-x-1 text-neutral-900 dark:text-neutral-100">
          <span className="font-bold italic">Ayesha Fatima</span>
          <a href="/" className="hover:underline"></a>
        </div>
        <div className="flex flex-row items-center justify-center space-x-2 mb-1">
          <a href="https://github.com/Ayeshafatimach2" rel="noreferrer" target="_blank">
          ...
          <a
            href="https://www.fiverr.com/ayeshafatimach?up_rollout=true"
            rel="noreferrer"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/ayesha-fatima-ch2/"
            rel="noreferrer"
            target="_blank"
          >
            <svg
          ...
          <a
            href="https://www.instagram.com/webcode_crafter?igsh=MTQ2amxwOXQzNzR5"
            rel="noreferrer"
            target="_blank"
          >
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="35" viewBox="0 0 48 48">
